...
public class TeacherDetail {
    ...
    @Column(name="id")
    private int id;
    @Column(name = "indentification_number")
    ...
    @Column(name = "avatar")
    private Blob avatar;
    /* *Note14.8* mappedBy in "TeacherDetail" class then this Class will be created first
     * then Spring create "Teacher" class then table "teacher" will own the relationship between
     * two entity
     * */
